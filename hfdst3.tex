...
van~\citeauthor{Dhondt_Pochat_Voulimeneas_Joosen_Volckaert_2022}
en~\citeauthor{Verdonck_2022}~\cite{Verdonck_2022,
    Dhondt_Pochat_Voulimeneas_Joosen_Volckaert_2022}. Deze aanvallen worden
...
meter~\cite{Dhondt_Pochat_Voulimeneas_Joosen_Volckaert_2022, Verdonck_2022}.
\begin{figure}[h]
    \centering
...
\ac{EPZ}. Dit is waar de gebruiker de \ac{EPZ} betreedt en/of verlaat. Deze
`zones' vormen zich dan ook rond wegen die de \ac{EPZ} betreden. Op
...
filteren van afwijkende activiteiten. De detectie ervan gebeurt via het \ac{DBSCAN}-algoritme.
\begin{figure}
    \centering
...
% Extra: Figuur of filteren van activiteiten
% Figuur predicties uitleggen
% Figuur LAD predictie invoegen