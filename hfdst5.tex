...
% Beschrijven hoe getest en geëvalueerd wordt
%   - Zeggen dat een uncloaked activities manueel worden gecloaked - Aanbrengen EPZ
%   - Bepaling GT
...
\begin{table}[H]
    \centering
    \captionsetup{justification=centering}
    \caption{Attack with normal gps-points (No Smoothing)}\label{tab:noSmoothing}
    \scalebox{0.5}{
        \begin{tabular}{lrrrrrrrr}
            \toprule
            {}         & Success Rate (\%) & Correctness (m) & Accuracy & Reduction (\%) & Uncertainty Region ($m^2$) & Certainty & Spatial Certainty & Degree of Anonymity (\%) \\
